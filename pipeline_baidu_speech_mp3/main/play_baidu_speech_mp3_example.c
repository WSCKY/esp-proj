...
#define TTS_TEXT "根据国家统计局2010年进行的人口普查数据，00后总人口大概1.46亿左右，其中男生比女生多将近1300万。其中，每一个年龄段男生大约比女生多100万左右，甚至更多。"
...
int _http_stream_event_handle(http_stream_event_msg_t *msg)
{
    ...
    int data_len = snprintf(request_data, 1024, "lan=zh&cuid=kyChu&ctp=1&tok=%s&tex=%s", baidu_access_token, TTS_TEXT);
