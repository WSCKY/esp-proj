...
//    while(1) {
      ...
      for(int y = 0; y < PARALLEL_LINES * 3; y += PARALLEL_LINES) {
        send_lines(spi, y + 0, lines[0]);
      ...
      for(int y = 0; y < PARALLEL_LINES * 3; y += PARALLEL_LINES) {
        send_lines(spi, y + PARALLEL_LINES * 3, lines[0]);
        send_line_finish(spi);
      }
      for(int y = 0; y < 320*PARALLEL_LINES; y ++) {
#if CONFIG_LCD_COLOR_BIG_ENDIAN
      ...
      for(int y = 0; y < PARALLEL_LINES * 3; y += PARALLEL_LINES) {
        send_lines(spi, y + PARALLEL_LINES * 6, lines[0]);
        send_line_finish(spi);
      }
      for(int y = 0; y < 320*PARALLEL_LINES; y ++) {
#if CONFIG_LCD_COLOR_BIG_ENDIAN
      ...
      for(int y = 0; y < PARALLEL_LINES * 3; y += PARALLEL_LINES) {
        send_lines(spi, y + PARALLEL_LINES * 9, lines[0]);
        send_line_finish(spi);
      }
      for(int y = 0; y < 320*PARALLEL_LINES; y ++) {
#if CONFIG_LCD_COLOR_BIG_ENDIAN
      ...
      for(int y = 0; y < PARALLEL_LINES * 3; y += PARALLEL_LINES) {
        send_lines(spi, y + PARALLEL_LINES * 12, lines[0]);
        send_line_finish(spi);
      }
//      while(1) {
